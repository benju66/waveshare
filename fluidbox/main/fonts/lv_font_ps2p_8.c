 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --font PressStart2P.ttf --size 8 --bpp 1 --format lvgl --no-compress -r 0x20-0x7E -r 0xB0 -o lv_font_ps2p_8.c
 ******************************************************************************/
...
#ifndef LV_FONT_PS2P_8
#define LV_FONT_PS2P_8 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 518, .adv_w = 128, .box_w = 3, .box_h = 3, .ofs_x = 2, .ofs_y = 5}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_ps2p_8 = {
#else
lv_font_t lv_font_ps2p_8 = {
#endif
